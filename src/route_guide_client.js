...
// // Stub Constructor is in the routeguide namespace -> protoDescriptor.routeguide.RouteGuide
// // Service Descriptor (used to create a server) is a property of the stub -> protoDescriptor.routeguide.RouteGuide.service
// // To call service methods, we need to create a `stub`. 
// // To do this, we just need to call the RouteGuide stub constructor, specifying the server address and port. 
